...
void Diaporama::charger()
{
    ...
    switch(id) {
      case 0 : // diaporama par défaut
        imageACharger = new ImageDansDiaporama(1, "objet", "", ":/imagesDur/cartesDisney/Disney_tapis.gif");
      ...
      case 1 : // diaporama de Pantxika
          ...
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(1, "animal", "Mickey", ":/imagesDur/cartesDisney/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
      case 2 : // diaporama de Thierry
          imageACharger = new ImageDansDiaporama(1, "personnage", "Pinnochio", ":/imagesDur/cartesDisney/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(2, "personnage", "Blanche Neige", ":/imagesDur/cartesDisney/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
      ...
      case 3 : // diaporama de Yann
          imageACharger = new ImageDansDiaporama(2, "personnage", "Pinnochio", ":/imagesDur/cartesDisney/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
      ...
      case 4 : // diaporama de Manu
          imageACharger = new ImageDansDiaporama(4, "personnage", "Pinnochio", ":/imagesDur/cartesDisney/Disney_29.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(3, "personnage", "Blanche Neige", ":/imagesDur/cartesDisney/Disney_4.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(2, "personnage", "Alice", ":/imagesDur/cartesDisney/Disney_2.gif");
          ajouterImageEnFin(imageACharger);
          imageACharger = new ImageDansDiaporama(1, "animal", "Mickey", ":/imagesDur/cartesDisney/Disney_19.gif");
          ajouterImageEnFin(imageACharger);
          break ;//
